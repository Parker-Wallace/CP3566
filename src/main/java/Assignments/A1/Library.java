...
/**
 * Represents a library which contains books which are written by authors<p>
 * Assists in maintaining the relationships between Authors and Books as well as mitigating excessive read/write
...
public class Library {
     ...
     * @param books a List of {@link Book} objects to be added to the initial library
     * @param authors a List of {@link Author} objects to be added to the initial library
     */
    ...
    /**
     * constructor for the {@link Library} class which utlizes a database connection to populate entries
     * @param db the Bookdatabase manager which makes the requisite database calls to populate the data
     * @throws SQLException
     */
    ...
    /**
     * Edits an {@link Author} in this library<p>
     ...
     * @param indexOfAuthor the index of the author in the list of authors in this library
     * @param newFirstName the new first name for the author at the index position of authors in this library
     * @param newLastName the new last name for the author at the index position of authors in this library
     * @throws SQLException
     */
     ...
     * @param db the database manager object for facilitating database queries
     * @param indexOfBook the index of the book in the list of books in this library
     * @param newTitle the new title for the book at the index position of books in this library
     * @param newEditionNumber the new edition number for the book at the index position of books in this library
     * @param newCopyright the new copyright year for the book at the index position of books in this library
     * @throws SQLException
     */
    ...
    /**
     * adds a book object to this library and initializes an insert query to the database
     * @param db the database management object for facilitating adding the book to the database
     * @param book the book object to be added to this library and the backend database
     * @throws SQLException
     */
